...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Testing data generator for off-grid angles in [1]. Their values are
% randomly chosen from each interval.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
MISC.size = (MISC.S(end)+1)*pars.d*100; % [cm]
...
for k=1:SOURCE.K
    ...
    A_misc(:,k) = MISC_steer_vec(SOURCE.angles(k,n));
end
...
% (rename accordingly)
if pars.T==16
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5','/sam', size(vR.sam));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5', '/sam', vR.sam);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5','/theor',size(vR.the));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5', '/theor', vR.the);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5','/angles',size(vR.angles));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5', '/angles', vR.angles);
h5disp('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T16.h5');
elseif pars.T==32                                     
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5','/sam', size(vR.sam));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5', '/sam', vR.sam);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5','/theor',size(vR.the));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5', '/theor', vR.the);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5','/angles',size(vR.angles));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5', '/angles', vR.angles);
h5disp('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T32.h5');
elseif pars.T==64   
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5','/sam', size(vR.sam));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5', '/sam', vR.sam);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5','/theor',size(vR.the));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5', '/theor', vR.the);
h5create('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5','/angles',size(vR.angles));
h5write('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5', '/angles', vR.angles);
h5disp('C:\...\Test_DATA_R_re_im_75K_s6_30dB_T64.h5');   
end
